...
const file_transport_internet_finalmask_header_srtp_config_proto_rawDesc = "" +
	...
	"\x06ConfigB\xb1\x01\n" +
	"1com.xray.transport.internet.finalmask.header.srtpP\x01ZJgithub.com/cloudpassion/xray-core/transport/internet/finalmask/header/srtp\xaa\x02-Xray.Transport.Internet.Finalmask.Header.Srtpb\x06proto3"
