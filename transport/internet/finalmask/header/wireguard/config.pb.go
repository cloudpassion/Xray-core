...
const file_transport_internet_finalmask_header_wireguard_config_proto_rawDesc = "" +
	...
	"\x06ConfigB\xb8\x01\n" +
	"6com.xray.transport.internet.finalmask.header.wireguardP\x01ZGgithub.com/cloudpassion/Xray-core/transport/internet/finalmask/header/wireguard\xaa\x022Xray.Transport.Internet.Finalmask.Header.Wireguardb\x06proto3"
